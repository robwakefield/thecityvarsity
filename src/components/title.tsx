...
export default function Title(title: string, subtitle: string, buttonText: string, ticketLink: string) {
  ...
  return (
    <div className="w-screen min-h-[500px] h-[40%] md:h-[50%] lg:h-[75%] bg-bg">
        <div className="w-full h-full bg-no-repeat bg-center bg-cover bg-hero-mobile md:bg-hero">
        <div className="h-full w-full backdrop-brightness-[0.70] md:backdrop-brightness-[0.78] flex items-center">
